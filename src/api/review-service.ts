...
export const reviewService = {
    getReviewsByEstablishmentId: (establishmentId: string): GetReviewsByEstablishmentIdResponse => api.get(`/establishment/${establishmentId}/reviews`),
    createReview: (establishmentId: string, payload: CreateReviewDto): CreateReviewResponse => api.post(`/establishment/${establishmentId}/reviews`, payload),
